...
const ActionPointsController = {
  ...
  create: async (req, res) => {
    try {
      ...
      return response.error(res, error.message || "Failed to create action point");
    }
  },
  ...
  getByProject: async (req, res) => {
    try {
      ...
      const items = await ActionPoints
        .find({ projectId })
        .sort({ createdAt: -1 });
      ...
      return response.error(res, error.message || "Failed to fetch action points");
    }
  },
  ...
  getOne: async (req, res) => {
    try {
      ...
      return response.error(res, error.message || "Failed to fetch action point");
    }
  },
  ...
  update: async (req, res) => {
    try {
      ...
      return response.error(res, error.message || "Failed to update action point");
    }
  },
  ...
  delete: async (req, res) => {
    try {
      ...
      return response.error(res, error.message || "Failed to delete action point");
    }
  }
};
