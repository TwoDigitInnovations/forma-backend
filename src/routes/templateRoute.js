...
router.get("/getTemplatesByProjectId/:projectId", authenticate, TemplateController.getTemplatesByProjectId);
router.delete("/deleteTemplate/:id", authenticate, TemplateController.deleteTemplate);
